...
// sending information for the server as JSON data

app.get('/jsontestx', function (req,res) {
    res.type('json');
    res.send({name:"5ra 3leek", age: "500", test:"testing"});
    console.log('Json sent')
})



// creating json and sending it to the brwoser
app.get('/jsontestv2', function (req,res) {
    const myjson = {
        name: "amir",
        cardetails: {
            model: '50x',
...
// get operation with download function
app.get('/download', (req,res) => {
    res.download('./public/download.pdf');
})




// Redirecting with get operation 
